...
\item<4->
\begin{alltt}
        [(> (length to-match) (length patt)) \textcolor{darkgreen}{patt already detected}
         (list s last-read s)]
\end{alltt}
...
;; Tests for D
(check-reject? D \quot(a) \quot(a b b) \quot(a a) \quot(b a a b) \quot(a b a b a b b))
(check-accept? D \elist \quot(a b) \quot(a b a) \quot(a b a b) \quot(a b a a b a a b))
...
\begin{alltt}
   ...
   (check-reject? M \quot{}(a b c) \quot{}(b b a b c b a) \quot{}(b a c))
   (check-accept? M \elist{} \quot{}(a b) \quot{}(a b a) \quot{}(a b a b) \quot{}(a c a a c a a c) \quot{}(c c c b c c c))
   (check-equal? (sm-testequiv? AT-LEAST-ONE-MISSING M 500) #t)
   (check-equal? (sm-testequiv? M (ndfa->dfa AT-LEAST-ONE-MISSING) 500) #t)

   (define D (ndfa2dfa ND))
   (check-reject? D \quot{}(a) \quot{}(a b b) \quot{}(a a) \quot{}(b a a b) \quot{}(a b a b a b b))
   (check-accept? D \elist \quot{}(a b) \quot{}(a b a) \quot{}(a b a b) \quot{}(a b a a b a a b))
   (check-equal? (sm-testequiv? ND D 500) #t)
   (check-equal? (sm-testequiv? D (ndfa->dfa ND) 500) #t)
\end{alltt}
...
\item<3->
\begin{alltt}
(check-reject? ab*Ua-aUb-b* \elist{} \quot{}(a a a a))
(check-accept? ab*Ua-aUb-b* \quot{}(a b) \quot{}(a a b b))
(check-equal? (sm-testequiv? ab*Ua-aUb-b* (sm-union ab* ab*Ua-aUb-b*)) #t)

(check-reject? ab*Uaab* \quot{}(a a a) \quot{}(b a b a))
(check-accept? ab*Uaab* \quot{}(a b b) \quot{}(a b b) \quot{}(a a b) \quot{}(a b b b b))
...
\item<3->
\begin{alltt}
(check-reject? ab*-o-a-aUb-b* \quot{}() \quot{}(b b b) \quot{}(a a b a b))
(check-accept? ab*-o-a-aUb-b* \quot{}(a b a a b) \quot{}(a b b b a a))
(check-equal? (sm-testequiv? ab*-o-a-aUb-b* (sm-concat ab* a-aUb-b*)) #t)

(check-reject? ab*-o-aab* \quot{}() \quot{}(a b a) \quot{}(a a b b a a))
(check-accept? ab*-o-aab* \quot{}(a b b a a b b) \quot{}(a a a))
...
(check-reject? a-aUb-b*-* \quot{}(b b b) \quot{}(a b a b a a a a))
(check-accept? a-aUb-b*-* \quot{}() \quot{}(a a a a b b b b) \quot{}(a a b a a b b a a))
(check-equal? (sm-testequiv? a-aUb-b*-* (sm-kleenestar a-aUb-b*)) #t)

(check-reject? ab*-* \quot{}(b) \quot{}(b b b))
(check-accept? ab*-* \quot{}() \quot{}(a a a a) '\quot{}(a b a b b a b b b))
...
(check-reject? not-a* \quot{}() \quot{}(a a a))
(check-accept? not-a* \quot{}(a a b) \quot{}(b b a a b))
(check-equal? (sm-testequiv? not-a* (sm-complement a*)) #t)

(check-reject? not-EVEN-A-ODD-B \quot{}(b) \quot{}(a a b) \quot{}(b b a b a))
(check-accept? not-EVEN-A-ODD-B \quot{}() \quot{}(b b a a) \quot{}(a a b b a b))
...
\begin{alltt}
  (let* [(notM (complement-fsa (ndfa2dfa M)))
    ...
    (complement-fsa (ndfa2dfa (sm-union notM notN))))) 
    \textcolor{darkgreen}{sm-union does not assume intersection of states is empty}
\end{alltt}
...
(check-reject? ab*-intersect-a-aUb-b* \quot{}() \quot{}(a b b a) \quot{}(a b))
;; L(ab*-intersect-a-aUb-b*) = \(\varnothing\)
(check-equal? (sm-testequiv? ab*-intersect-a-aUb-b* (sm-intersection ab* a-aUb-b*)) #t)

(check-reject? a-aUb-b*-intersect-EVEN-A-ODD-B \quot{}() \quot{}(b b) \quot{}(a a b b))
(check-accept? a-aUb-b*-intersect-EVEN-A-ODD-B \quot{}(a a b) \quot{}(a a b b b))
...
(define e (empty-regexp))         (define a (singleton-regexp "a")) 
(define b (singleton-regexp "b"))
(define ab (concat-regexp a b))   (define aa (concat-regexp a a))
...
\item<3->
\begin{alltt}
(check-reject? Me  \quot{}(a))      (check-accept? Me  \quot{}())
(check-reject? Ma  \quot{}(b))      (check-accept? Ma  \quot{}(a))
(check-reject? Mab \quot{}())       (check-accept? Mab \quot{}(a b))
(check-reject? Maa \quot{}(b a a))
(check-accept? Maa \quot{}(a a))
(check-reject? MabUMe   \quot{}(a b a a) \quot{}(b b))
(check-accept? MabUMe   \quot{}() \quot{}(a b))
(check-reject? MabUaa   \quot{}(a b b b) \quot{}(b a b))
(check-accept? MabUaa   \quot{}(a a) \quot{}(a b))
(check-reject? Maa-*    \quot{}(a b) \quot{}(a a a))
(check-accept? Maa-*    \quot{}(a a) \quot{}(a a a a a a))
(check-reject? MabUaa-* \quot{}(a b a) \quot{}(b b b b))
(check-accept? MabUaa-* \quot{}() \quot{}(a a a a a b))
\end{alltt}
...
\item<4->
\begin{alltt}
         (new-final (gen-state (sm-states m)))
\end{alltt}
...
\begin{alltt}
         (init-dgraph (make-dgraph
                       (cons (list new-start EMP (sm-start m))
                             (append
                              (map (\lamb (f) (list f EMP new-final)) (sm-finals m))
                                   (sm-rules m)))))
\end{alltt}
...
(define ba*Uab*-regexp (ndfa2regexp ba*Uab*))
(define EVEN-A-ODD-B-regexp (ndfa2regexp EVEN-A-ODD-B))

(check-equal? (printable-regexp (ndfa2regexp NULL)) "\(\varnothing\)") ;; \textcolor{darkgreen}{null-regexp cannot gen words}
(check-accept? b* (gen-regexp-word b*-regexp))

(check-accept? ba*Uab* (gen-regexp-word ba*Uab*-regexp)
               (gen-regexp-word ba*Uab*-regexp)
               (gen-regexp-word ba*Uab*-regexp)
               (gen-regexp-word ba*Uab*-regexp))

(check-accept? EVEN-A-ODD-B (gen-regexp-word EVEN-A-ODD-B-regexp)
                            (gen-regexp-word EVEN-A-ODD-B-regexp)
                            (gen-regexp-word EVEN-A-ODD-B-regexp)
                            (gen-regexp-word EVEN-A-ODD-B-regexp))
\end{alltt}
...
(define MULT3-as 
  (make-rg \quot{}(S B C)
           ...
           \qquot{}((S ,ARROW ,EMP)
             ...
             (C ,ARROW bC))
           \quot{}S
           #:rejects \quot{}((b b a b b) (b b a b b a) 
                       (b b a b a b a a b))
           #:accepts \quot{}(() (a a a) (b b a a b a b b))))
\end{alltt}
...
(check-accept? SIGMA*    \quot{}() \quot{}(a b c) \quot{}(c c a b a c))
(check-derive? SIGMA*-rg \quot{}() \quot{}(a b c) \quot{}(c c a b a c))

(check-reject?     EVEN-A-ODD-B \quot{}(a b) \quot{}(a a b a))
(check-not-derive? EA-OB-rg     \quot{}(a b) \quot{}(a a b a))
(check-accept?     EVEN-A-ODD-B \quot{}(b) \quot{}(b a a b b))
(check-derive?     EVEN-A-ODD-B \quot{}(b) \quot{}(b a a b b))
\end{alltt}
...
\begin{alltt}
;; Tests for rg2ndfa
(define SIGMA*-ndfa (rg2ndfa SIGMA*-rg))
(define EA-OB-ndfa  (rg2ndfa EA-OB-rg))
(define a*Ub*-ndfa  (rg2ndfa a*Ub*-rg))
(define a-aba-ndfa  (rg2ndfa a-aba-rg))

(check-derive?     SIGMA*-rg   \quot{}() \quot{}(a b c) \quot{}(c c a b a c))
(check-accept?     SIGMA*-ndfa \quot{}() \quot{}(a b c) \quot{}(c c a b a c))
(check-equal? (sm-testequiv? SIGMA* SIGMA*-ndfa) #t)

(check-not-derive? EA-OB-rg   \quot{}(a b) \quot{}(a a b a))
(check-reject?     EA-OB-ndfa \quot{}(a b) \quot{}(a a b a))
(check-derive? EA-OB-rg   \quot{}(b) \quot{}(b a a b b))
(check-accept? EA-OB-ndfa \quot{}(b) \quot{}(b a a b b))
(check-equal? (sm-testequiv? EVEN-A-ODD-B EA-OB-ndfa) #t)

(check-not-derive? a*Ub*-rg   \quot{}(a b) \quot{}(a b b a))
(check-reject?     a*Ub*-ndfa \quot{}(a b) \quot{}(a b b a))
(check-derive? a*Ub*-rg   \quot{}() \quot{}(a a a) \quot{}(b))
(check-accept? a*Ub*-ndfa \quot{}() \quot{}(a a a) \quot{}(b))

(check-not-derive? a-aba-rg   \quot{}(b b) \quot{}())
(check-reject?     a-aba-ndfa \quot{}(b b) \quot{}())
(check-derive? a-aba-rg   \quot{}(a b a) \quot{}(a))
(check-accept? a-aba-ndfa \quot{}(a b a) \quot{}(a))
\end{alltt}
